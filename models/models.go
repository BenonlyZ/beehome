...
func init() {
	...
	orm.RegisterDataBase("default", "mysql", "root:123@tcp(127.0.0.1:3306)/lovehome2?charset=utf8", 30)

	// register mode
	orm.RegisterModel(new(User), new(House), new(OrderHouse), new(HouseImage), new(Area), new(Facility))
